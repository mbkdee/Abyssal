...
contract AbyssalToken is IERC20 { 
     
    using SafeMath for uint256;
    //public variables
    string public constant symbol="FRES"; 
    string public constant name="Abyssal";
    ...
    function AbyssalToken(address _holder,address _foundation,address _team) public payable{
        require(_holder != 0x0);
